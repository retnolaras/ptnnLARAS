<div>
    <table cellspacing="0" cellpadding="10px" width="90%">
        ...
        <tr id="data<?php echo $menu['id']?>">
            ...
            <a style="text-decoration:none;" href="admin/page/hapus_top_menu/<?php echo $menu['id']?>" onclick="return confirm('Apakah yakin ingin menghapus file ini?')"><input type="button" value="Hapus"  /></a></td>
        </tr>
        ...
        <tr style="background-color: #5DF;">
            <form action="admin/page/insert_top_menu/" method="post" >
            <td>+</td>
            <td>+</td>
...
<script type="text/javascript">
    function update(id, nomor)
    {
        ...
        $.ajax({
                url: 'admin/page/update_top_menu/' + id,
                type: 'POST',
                data: dataEdit,
                success: function() {
                        $('#data'+id).load('admin/page/load_menu/' + id + '/' + nomor);
                },
                error: function(){
