...
{?>
            ...
            <td width="150px" class="options-width"><input type="button" value="Edit" onclick="edit(<?php echo $menu['id']?>)" />
                <a style="text-decoration:none;" href="admin/page/hapus_top_menu/<?php echo $menu['id']?>" onclick="return confirm('Apakah yakin ingin menghapus file ini?')"><input type="button" value="Hapus"  /></a>
            </td>
        </tr>
