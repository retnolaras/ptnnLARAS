...
<div id="page-heading"><h1>Edit Database Dosen</h1></div>
...
{?>
		...
		<tr>
			...
			<td><input type="text" size="10" name="kode" value="<?php echo $list['kode']; ?>" /></td>
		</tr>
		<tr>
			<th valign="top">Divisi </th>
			<td><input type="text" size="36" name="divisi" value="<?php echo $list['divisi']; ?>" />  &nbsp; id Divisi : <input type="text" size="5" name="id_div" /> </td>
		</tr>
		<tr>
			<th valign="top">Laboratory </th>
			<td><input type="text" size="36" name="Lab" value="<?php echo $list['Lab']; ?>" /> &nbsp; id Lab : <input type="text" size="5" name="id_lab" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" size="30" name="tgl_lahir" value="<?php echo $list['tgl_lahir']; ?>" /></td> 
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea id="file"  type="text" row="30" cols="46" name="riset"><?php echo $list['riset']; ?></textarea></td> 
		</tr>
		<tr>
			<th valign="top">&nbsp;</th>
			<td></td> 
		...
		<tr>
			...
			<td><textarea id="file3" type="text" row="30" cols="46" name="pendidikan"><?php echo $list['pendidikan']; ?></textarea></td> 
		</tr>
		<tr>
			<th valign="top">&nbsp;</th>
			<td></td> 
		...
		<tr>
			...
			<td><textarea id="file2" type="text" row="30" cols="46" name="publikasi"><?php echo $list['publikasi']; ?></textarea></td> 
		</tr>
	<tr>
		<th valign="top">&nbsp;</th>
		<td>&nbsp;</td>
